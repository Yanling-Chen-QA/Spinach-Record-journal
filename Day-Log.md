...
- [x] 1H:agent项目代码跑起来
- [x] 2H:agent项目代码理解
- [x] 1H:把chatprompttemplate学习代码整理进项目1文档
- [x] 2H:微信服务号境外授权登录调研
- [x] 输出一份agent整理笔记
...
- [x] 1H:重新跑一下最新的excel
- [x] 2H:梳理代码逻辑
- [x] 1H:找微信第三方授权的中转案例或开源代码
- [x] 0.5H:把agent的学习笔记整理成文档pdf并发自媒体

### ideas
- 昨晚看清水至方还有i老师的情景剧。弄得我非常想吃逼，想当1，感觉会很爽。
...
# Day33(26-06-17)
### todo
- [x] 1H:调整一下插件：resize/minsize/字段一行一行
...
- [x] 好好思考到底学算法还是开发，和ai好好聊一聊
- [x] 1H:把agent实战项目7中的拓展完成
