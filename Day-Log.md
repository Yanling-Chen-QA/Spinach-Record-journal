...
## Day46(26-08-26)
### todo
- [x] 2H: 想想新的清理废弃代码如何做，是否可以写成自动化脚本

## Day47(26-08-27)
### todo
- [x] 2H: 想想新的清理废弃代码如何做，是否可以写成自动化脚本
- [x] 今天一定要把小作文发掉，然后就是社团公众号做完

## Day48(26-08-31)
### todo
- [x] 2H: 清理代码的脚本参照check_api_coverage写
- [x] 理一理近期规划
  

## Day49(26-09-02)
### todo
- [x] 2H: 清理代码的脚本 —— 删除unused的脚本，删完之后本地编译然后pr
- [ ] 2H：重启人生，最近有点胃痛
- [ ] 写公众号（顺便看看能不能抓人帮忙写一篇），给韩老师建队约时间/杨老师社团签字，招新
- [ ] 做饭：公瑾爆蛋，虾仁黄瓜火腿玉米，西兰花（？），泡椒藕段牛肉/蒜苗辣椒炒肉，三文鱼成品/带鱼，老鸭汤（每道菜练上2-3次就好了）
...
二、每个细分
1. 学业
- 论文（这段时间重点），开学前搞定，最好就是同时出一个专利初稿

2. 工作
- 继续偷学到找到下一份工作，算法类，但也要看看能不能平衡生活
- 规划还是先卷一小下，其实更多地应该拓展其他路径，比如外企/非互联网行业什么的

3. 攀岩
- 自身进步、教学提升(想做一版高质量的教学结构)
- 攀岩社团：指导老师、社团宣发、社团结构、（开学前弄好）。
韩老师，冒昧来打扰您了，（比赛成绩+很多热爱的人，很想把这些事情做起来，但是迫于没有指导老师，每一次比赛都需要请求很多很多老师和部门才能有报名资格，所以我们希望能得到您的指导）
前段时间我们参加了两场比赛，一个是22届中国大学生攀岩锦标赛，拿到了冠军、全国第六和全国第七的好成绩；另一个是上海市攀岩职业技能大赛，高校团体二等奖/三等奖，以及个人二等奖/优胜奖。
- 攀岩赚钱

1. 情感
- 和小岭的关系，真是让人不知道会发生什么呢，只是希望两个人能都尽量开心而不受到伤害
- 最近慢慢把一些事情实践了，发现性爱确实都不能分离，同时也能感觉有一定的排序和地位，虽然小岭还是会说小心她突然断崖之类的话，但至少看起来是幸福的。只是后面可能发生的这种被断崖的不安感受如何处理，还是不清楚
- 我的不安总是从我的细节出发去想的，但其实如果我把她做的事情列举出来，就会发现她是爱我的，所以我一下就不担心了，但是确实要好好学习一下doi
...
## Day50(26-09-03)
### todo
- [x] 2H: 清理代码的脚本 —— 解决conflict和conversation然后add mt和ld进reviewer